...
@Component({
  selector: 'app-grafico-mensual-lcp',
  templateUrl: './grafico-mensual-lcp.component.html',
  styleUrls: ['./grafico-mensual-lcp.component.scss'],
})
export class GraficoMensualLcpComponent  implements AfterViewInit, AfterViewChecked {
