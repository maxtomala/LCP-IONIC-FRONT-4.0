...
@Component({
  selector: 'app-participantes-lcp',
  templateUrl: './participantes-lcp.page.html',
  styleUrls: ['./participantes-lcp.page.scss'],
})
export class ParticipantesLcpPage implements OnInit {
